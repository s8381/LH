...
for(g = 19; g < 20; g++){
    ...
    snprintf(filename1, sizeof(char) * 128, "/pfs/work2/workspace/scratch/fr_yl1022-noneq-0/traj_k_inf_%.1f_%d.txt", epsilon, g);
    FILE *traj;
    traj = fopen(filename1, "w");
    snprintf(filename2, sizeof(char) * 128, "/pfs/work2/workspace/scratch/fr_yl1022-noneq-0/particle_num_k_inf_%.1f_%d.txt", epsilon, g);
    FILE *particle_num;
