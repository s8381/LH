...
for(g= 0; g<loop; g++){
    ...
    snprintf(filename1, sizeof(char) * 128, "/pfs/work2/workspace/scratch/fr_yl1022-r_inflection-0/wp_woD/k_inf/traj_k_inf_%.1f.txt", epsilon);
    FILE *traj;
    traj = fopen(filename1, "w");
    snprintf(filename2, sizeof(char) * 128, "/pfs/work2/workspace/scratch/fr_yl1022-r_inflection-0/wp_woD/k_inf/particle_num_k_inf_%.1f.txt", epsilon);
    FILE *particle_num;
